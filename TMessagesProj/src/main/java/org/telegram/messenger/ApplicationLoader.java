 ...
 *
 * TeleDrive modification — file storage app built on top of Telegram infrastructure.
 * Application ID: com.teledrive.app
 * Based on: https://github.com/DrKLO/Telegram (GPL v2)
 */
    ...
    public static void postInitApplication() {
        ...
        for (int a = 0; a < UserConfig.MAX_ACCOUNT_COUNT; a++) { //TODO improve account
            ...
            if (user != null) {
                ...
                // TeleDrive: initialise Drive layer for logged-in accounts
                org.telegram.messenger.drive.DriveRepository.getInstance(a).init();
            }
        }
