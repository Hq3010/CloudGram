...
public class BuildVars {
    ...
    public static int APP_ID = 0; // Obtain your own at https://my.telegram.org
    public static String APP_HASH = ""; // Obtain your own at https://my.telegram.org

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = ""; // Obtain your own from Google Cloud Console
    public static String PLAYSTORE_APP_URL = "";
    public static String HUAWEI_STORE_URL = "";
    public static String GOOGLE_AUTH_CLIENT_ID = ""; // Obtain your own from Google Cloud Console
